...
from monty.serialization import loadfn, dumpfn
db = connect("clease_MnNiAs-gs.db")
atom1 =  db.get(id=3).toatoms()
struct = AseAtomsAdaptor.get_structure(atom1)
...
energies_file = os.path.join(directory,"comp-initstruct-energy.json" )
