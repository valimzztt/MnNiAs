...
vasp.write_vasp('POSCARmin3000.vasp', sorted_atoms, direct=False, wrap=False)
# convert current energy structure to ASE atoms 
atoms = AseAtomsAdaptor.get_atoms(curr_s)
sorted_atoms=sort(atoms)
vasp.write_vasp('POSCARcurr3000.vasp', sorted_atoms, direct=False, wrap=False)
...
with open('MC_3000K_eq.json','w') as f:
