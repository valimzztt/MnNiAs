...
db = connect(db_name)
species = {"Mn": 0.5, "Ni": 0.5}
#get primitive structure
atom1 = db.get(id=1).toatoms()
prim = AseAtomsAdaptor.get_structure(atom1)
prim[0] =  {"Mn": 0.5, "Ni": 0.5}
prim[1] = {"Mn": 0.5, "Ni": 0.5}
...
cutoffs = {2: 7, 3: 7, 4: 7} 
subspace = ClusterSubspace.from_cutoffs(prim, cutoffs=cutoffs,supercell_size='As')
...
energies_file = os.path.join(dft_data ,"comp-struct-energy.json" )
