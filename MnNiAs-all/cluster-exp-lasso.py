...
energies_file = os.path.join(dft_data ,"allstruct-energy-scf.json" )
...
reg = Lasso(fit_intercept=False, alpha=1.0985411419875573)
...
file_path = 'ce-data/ce_MnNiAs_lasso2.mson'
